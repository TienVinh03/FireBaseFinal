...
GoogleSignin.configure({
  webClientId: '371805304155-084qipsk9hto9o0ep6n3l1o4tg8765rk.apps.googleusercontent.com', // Get this from Firebase console
});
...
const SigninScreen = ({navigation}) => {
  ...
  return (
    <View style={{flex:1,backgroundColor:'white',padding:20}}>
      <TouchableOpacity style={{alignSelf:'flex-end',marginEnd:0,marginTop:20}} onPress={()=>navigation.navigate('Welcome')}>
      ...
      <TouchableOpacity onPress={onGoogleButtonPress} style={{alignItems:'center',
